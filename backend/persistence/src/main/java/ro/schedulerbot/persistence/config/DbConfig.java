...
@Configuration
@EnableJpaRepositories(basePackages = "ro.schedulerbot.persistence.repo",
    entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
public class DbConfig {

  @Autowired
  private SchedulerBotDbProperties prop;
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    if(prop.getHibernateCheckNullability().isPresent()) {
      jpaProperties.put("hibernate.check_nullability", prop.getHibernateCheckNullability().get());
    }
